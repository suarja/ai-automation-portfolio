  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <section className="relative overflow-hidden rounded-3xl border border-border shadow-card backdrop-blur-sm bg-gradient-to-br from-elevated to-card mb-12">
          ...
          <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center">
            <div className="md:w-3/5 mb-8 md:mb-0 md:pr-8">
              ...
              <p className="text-xl text-soft mb-8">
        ...
        <section className="mb-16">
          <div className="relative overflow-hidden rounded-3xl border border-border shadow-card backdrop-blur-sm bg-gradient-to-br from-elevated to-card p-8 md:p-12">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="relative pt-8 overflow-hidden rounded-3xl border border-border shadow-card backdrop-blur-sm bg-gradient-to-br from-elevated to-card p-8">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <CheckCircleIcon className="h-5 w-5 text-emerald-600 dark:text-emerald-400 mr-2 mt-0.5" />
            ...
            <div className="relative overflow-hidden rounded-3xl border border-border shadow-card backdrop-blur-sm bg-gradient-to-br from-elevated to-card p-8">
              ...
              <p className="text-muted-foreground mb-6">On s'occupe de tout pour toi</p>
              <div className="mb-6">
                <span className="text-4xl font-bold">1997€</span>
                <span className="text-muted-foreground ml-2">prix de base</span>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  <CheckCircleIcon className="h-5 w-5 text-emerald-600 dark:text-emerald-400 mr-2 mt-0.5" />
                ...
                <li className="flex items-start text-sm text-muted-foreground mt-2">
                  <span>
              ...
              <Button
                asChild
                size="lg"
                className="w-full rounded-full bg-secondary hover:bg-muted text-foreground"
              >
                <a
        ...
        {/* CTA Final */}
        <section className="mb-16">
          <div className="relative overflow-hidden rounded-3xl border border-border shadow-card backdrop-blur-sm bg-gradient-to-br from-purple-900 to-indigo-900 p-8 md:p-12 text-center">
            <h2 className="text-3xl font-bold mb-4">
